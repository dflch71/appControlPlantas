...
class GetItemsActoUseCase @Inject constructor(private val itemRepository: ItemRepository) {
    operator fun invoke(): Flow<List<ItemModel>> = itemRepository.itemsActo
}